 ...
 */
 ...
 Paso 2. Invariante
 En esta version alternativa vamos a ir llevando el tamaño de la rejila en el invariante
 suma no puede ser <= k, si no, que el resultado es el tamaño de la rejilla
 ...
 En esta estrategia siempre añadiremos el ultimo termino a la rejilla: suma = suma + a[j] , pero entonces se viola 
